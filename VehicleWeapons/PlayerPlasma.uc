//=============================================================================
//=============================================================================
class PlayerPlasma extends VGProjectile;
...
simulated function SpawnExplosion(vector HitLocation, vector HitNormal)
{
	if(ExplosionClass != none)
		Spawn(ExplosionClass,,,HitLocation+HitNormal*ExploWallOut,Rotator(HitNormal * -1));
...
simulated function HitWall (vector HitNormal, actor Wall)
{
	...
	{
		Spawn(class'VehicleEffects.PulseImpactScorch',,,Location+HitNormal*ExploWallOut,Rotator(HitNormal * -1));
	}
...
defaultproperties
{
     ...
     TrailClass=Class'VehicleEffects.PlayerPlasmaTrail'
