...
var private native const int 	ReplacementMapPtr;
...
// this is a little gross, but the native code that is generated if you 
// use a byte array directly is wrong
//
event SendBinary(int Count, BinaryPacket Packet)
{
	Connection.SendBinary(Count, Packet.B);
}
