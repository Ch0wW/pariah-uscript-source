class AssassinLightning extends Emitter
	placeable;
...
defaultproperties
{
     Begin Object Class=BeamEmitter Name=BeamEmitter12
         ...
         BeamEndPoints(0)=(ActorTag="PrimeAssassin",Weight=1.000000)
         ...
         ColorScale(1)=(RelativeTime=0.250000,Color=(B=255,G=180,R=81))
         ColorScale(2)=(RelativeTime=1.000000,Color=(B=255,G=180,R=81))
     ...
     End Object
     Emitters(0)=BeamEmitter'VehicleEffects.BeamEmitter12'
     AmbientSound=Sound'BossFightSounds.Assassin.AssassinChargeUp'
     bNoDelete=False
}
