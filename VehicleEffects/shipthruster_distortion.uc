class shipthruster_distortion extends Emitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter25
         ...
         StartLocationRange=(X=(Min=10.000000,Max=10.000000),Z=(Min=-177.000000,Max=-190.000000))
         ...
         StartVelocityRange=(Z=(Min=-700.000000,Max=-800.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'VehicleEffects.SpriteEmitter25'
