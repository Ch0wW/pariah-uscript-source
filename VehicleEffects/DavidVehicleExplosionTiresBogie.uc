class DavidVehicleExplosionTiresBogie extends Vehicles;

defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter67
         StaticMesh=StaticMesh'PariahVehicleMeshes.bogie.BogieTire'
         MaxParticles=4
     ...
     End Object
     Emitters(0)=MeshEmitter'VehicleEffects.MeshEmitter67'
     ...
     End Object
     Emitters(1)=SpriteEmitter'VehicleEffects.SpriteEmitter356'
     Begin Object Class=SpriteEmitter Name=SpriteEmitter357
         ...
         UseRandomSubdivision=True
     End Object
     Emitters(2)=SpriteEmitter'VehicleEffects.SpriteEmitter357'
     AutoDestroy=True
     Tag="Emitter"
     Skins(0)=Texture'PariahVehicleTextures.Tire.BogieTireColour'
     bNoDelete=False
     bUnlit=False
}
