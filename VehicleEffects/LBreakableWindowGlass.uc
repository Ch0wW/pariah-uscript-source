class LBreakableWindowGlass extends Environmental;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter334
         ...
         StartLocationRange=(X=(Min=-10.000000,Max=10.000000),Y=(Min=-180.000000,Max=180.000000),Z=(Min=-140.000000,Max=140.000000))
         ...
         StartSizeRange=(X=(Min=6.000000,Max=15.000000))
         LifetimeRange=(Min=2.500000,Max=3.000000)
         StartVelocityRange=(X=(Min=-400.000000,Max=400.000000),Y=(Min=-50.000000,Max=50.000000),Z=(Max=100.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'VehicleEffects.SpriteEmitter334'
