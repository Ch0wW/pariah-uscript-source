...
function string GetInfo() {
	...
	ReplaceSubstring(ServerName,"\\","");	// strip \'s
...
function string GetRules()
{
	...
	if( Level.Game.AccessControl != None && Level.Game.AccessControl.HasGamePassword() )
...
function string GetPlayer( PlayerController P, int PlayerNum )
{
	...
	PlayerName = P.PlayerReplicationInfo.RetrivePlayerName();

	// Name
	ReplaceSubstring(PlayerName,"\\","");	// strip \'s
