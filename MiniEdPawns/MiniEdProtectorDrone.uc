class MiniEdProtectorDrone extends MiniEdAIDrone;
...
{
	return class'MiniEdPawnProtectorDrone';
}
...
state DisabledByEMP
{
	...
	function BeginState()
	{
		...
		MiniEdPawnProtectorDrone(Pawn).StartEMP();
//		SetTimer(5, false);
	}
	...
	function EndState()
	{
		...
		MiniEdPawnProtectorDrone(Pawn).EndEMP();
	}
}
