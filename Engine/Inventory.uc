...
var  byte           BarIndex;           // position on the weapon selection bar. similar to InventoryGroup only a little more logical.
...
var   bool		 bExtraDamping;		 // a little extra daming on the view bob (intended for heavy weapons)
...
simulated static function Precache();
...
{
	Instigator = Other;
	if(!bNoInventory)	//XJ don't add to inventory chain
