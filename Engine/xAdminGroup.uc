...
function Created()
{
	Users = new class'xAdminUserList';  // sjs[sg]
	Managers = new class'xAdminUserList';  // sjs[sg]
}
...
local int i;
	...
	{
		if (Instr("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789!%^*(){}[]<>.,", Mid(uname,i,1)) == -1)
		{
			Log( "character"@i@"("$Mid(uname,i,1)$") invalid" );
			return false;
		}
	}
