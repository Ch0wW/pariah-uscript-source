...
var(PclEmitter) float	mPreheatSeconds;
var(PclEmitter) float	mPreheatTicksPerSecond;
var	transient	bool	bPreheated;
var(PclEmitter) int		mStartParticles;	// at runtime also, you can set this > 0 to spawn this many next tick
var(PclEmitter) int		mMaxParticles;
...
defaultproperties
{
     ...
     mNumTileColumns=1
     mNumTileRows=1
     mPreheatTicksPerSecond=10.000000
